...
/**
* [1]:Smith [2]:Jodi [3]:Bernete [4]:Faith [2]:Jodi has 5 of 100 in the course
* math [4]:Faith has 70 of 100 in the course math [3]:Bernete has 49 of 100 in
* the course math The student [Jodi] percentage is 15.00% [4]:Faith has the
* highest 70 grade in math [2]:Jodi has the lowest 5 grade in math
*/
...
//@todo start the loop from 0 to ids length
       for (int index = 0; index < ids.length; index++) {
           ...
           // [3]:Bernete
           // [4]:Faith
           System.out.println("[" + (index + 1) + "]:" + studentsName[index]);
...
//
           ...
           */
           ...
           for (int index = 0; index < line.length(); ++index) {
               ...
               if (line.charAt(index) != ' ') {
                   ...
                   /**
                   * check the position and save it to the appropriate array 0 is a id 1 is a name
                   * 2 is a project
                   */
                   if (position == 0) {
       ...
       System.out.println("Max Grade of math: "+max);
       //@todo calculate min grade in a course such as
       System.out.println("Min grade of math: "+min);
   }
}
